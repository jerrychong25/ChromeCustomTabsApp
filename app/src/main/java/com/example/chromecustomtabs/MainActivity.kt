...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    companion object {
        private const val WEBSITE_URL = "http://www.google.com/"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val packageName = customTabHelper.getPackageNameToUse(this, WEBSITE_URL)

        if (packageName == null) {
            // if chrome not available open in web view
            val intentOpenUri = Intent(this, WebViewActivity::class.java)
            intentOpenUri.putExtra(WebViewActivity.EXTRA_URL, Uri.parse(WEBSITE_URL).toString())
